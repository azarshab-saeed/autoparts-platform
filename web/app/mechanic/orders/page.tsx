...
const label:Record<string,string>={pending:"در انتظار فروشگاه",accepted:"تأیید شده",ready:"آماده تحویل",fulfilled:"تحویل و خرید انجام شد",rejected:"رد شده",cancelled:"لغو شده",expired:"منقضی شده"};
