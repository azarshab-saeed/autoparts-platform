...
import { postSale, searchCustomers, searchProducts } from "@/lib/api";
...
export default function SalesPage(){
 ...
 const [busy,setBusy]=useState(false); const [success,setSuccess]=useState(""); const [error,setError]=useState("");
