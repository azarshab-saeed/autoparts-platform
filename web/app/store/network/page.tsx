...
export default function StoreNetworkPage(){
 ...
 async function saveOffer(x:NetworkStoreOffer){if(!session)return;setBusy(x.product_id);setMessage("");try{await updateNetworkStoreOffer(session,x.product_id,x.selling_price,x.visible,x.allow_reservation,x.allow_procurement!==false);setMessage(`«${x.title}» بروزرسانی شد.`);}catch(e){setMessage(e instanceof Error?e.message:"خطا");}finally{setBusy("");}}
