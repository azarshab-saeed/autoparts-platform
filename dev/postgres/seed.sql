...
INSERT INTO inventory_balances(tenant_id,warehouse_id,product_id,on_hand,reserved,avg_unit_cost) VALUES
 ('11111111-1111-1111-1111-111111111112','33333333-3333-3333-3333-333333333334','55555555-5555-5555-5555-555555555561',8,1,1310000),
 ...
 ('11111111-1111-1111-1111-111111111113','33333333-3333-3333-3333-333333333335','55555555-5555-5555-5555-555555555572',10,2,1170000)
ON CONFLICT(tenant_id,warehouse_id,product_id) DO UPDATE SET on_hand=EXCLUDED.on_hand,reserved=EXCLUDED.reserved,updated_at=now();
